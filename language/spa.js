...
Blockly.MIXLY_COOLGUY_LED='发光二极管LED';
Blockly.MIXLY_COOLGUY_BUZZER='Zumbador';
Blockly.MIXLY_COOLGUY_BTN='Botón';
Blockly.MIXLY_COOLGUY_VIBRATION='Vibración';
Blockly.MIXLY_COOLGUY_TILT='Tilt';
Blockly.MIXLY_COOLGUY_TOUCH='Pulsador';
Blockly.MIXLY_COOLGUY_MAGNETIC='Magnético';
Blockly.MIXLY_COOLGUY_PYROELECTRIC_INFRARED='Piroeléctrico infrarrojo';
Blockly.MIXLY_MB_PYROELECTRIC_INFRARED='Sensor Mov. PIR';
Blockly.MIXLY_COOLGUY_JOYSTICK_D='Boton Joystick';
Blockly.MIXLY_COOLGUY_JOYSTICK_A='Joystick';
Blockly.MIXLY_JOYSTICK='Joystick';
Blockly.MIXLY_COOLGUY_POTENTIOMETER='Potenciómetro';
Blockly.MIXLY_POTENTIOMETER='Potenciómetro';
Blockly.MIXLY_COOLGUY_ROTATION='Rotación';
Blockly.MIXLY_COOLGUY_VOLTAGE='Voltage';
Blockly.MIXLY_COOLGUY_PIEZO_DISK_VIRBRATION='Disco vibracion piezoelectrico';
Blockly.MIXLY_COOLGUY_SOUND='Sonido';
Blockly.MIXLY_SOUND='Sonido';
Blockly.MIXLY_COOLGUY_RELAY='Relé';
Blockly.MIXLY_COOLGUY_LIGHT='Luz';
Blockly.MIXLY_COOLGUY_GRAYSCALE='EscalaGrises';
Blockly.MIXLY_COOLGUY_FLAME='Llama';
Blockly.MIXLY_COOLGUY_TEMPERATURE='Temperatura';
Blockly.MIXLY_TEMPERATURE='Temperatura(℃)';
Blockly.MIXLY_COOLGUY_ACCELEROMETER='Acelerómetro';
Blockly.MIXLY_COOLGUY_MOISTURE='Humedad';
Blockly.MIXLY_COOLGUY_WATER='Agua';
Blockly.MIXLY_COOLGUY_CO='Monóxido Carbono';
Blockly.MIXLY_COOLGUY_SHARP_GP2Y0A21='Sharp GP2Y0A21';
