...
Blockly.MIXLY_COOLGUY_LED='发光二极管';
Blockly.MIXLY_COOLGUY_BUZZER='蜂鸣器';
Blockly.MIXLY_COOLGUY_BTN='按钮（数字）';
Blockly.MIXLY_COOLGUY_VIBRATION='震动（数字）';
Blockly.MIXLY_COOLGUY_TILT='倾斜（数字）';
Blockly.MIXLY_COOLGUY_TOUCH='触摸（数字）';
Blockly.MIXLY_COOLGUY_MAGNETIC='磁感应（数字）';
Blockly.MIXLY_COOLGUY_PYROELECTRIC_INFRARED='热释电红外（数字）';
Blockly.MIXLY_MB_PYROELECTRIC_INFRARED='人体红外';
Blockly.MIXLY_COOLGUY_JOYSTICK_D='摇杆-按钮（数字）';
Blockly.MIXLY_COOLGUY_JOYSTICK_A='摇杆（模拟）';
Blockly.MIXLY_JOYSTICK='摇杆';
Blockly.MIXLY_COOLGUY_POTENTIOMETER='电位器（模拟）';
Blockly.MIXLY_POTENTIOMETER='电位器';
Blockly.MIXLY_COOLGUY_ROTATION='角度（模拟）';
Blockly.MIXLY_COOLGUY_VOLTAGE='电压（模拟）';
Blockly.MIXLY_COOLGUY_PIEZO_DISK_VIRBRATION='压电陶瓷震动（模拟）';
Blockly.MIXLY_COOLGUY_SOUND='声音（模拟）';
Blockly.MIXLY_SOUND='声音';
Blockly.MIXLY_COOLGUY_RELAY='继电器';
Blockly.MIXLY_COOLGUY_LIGHT='光线（模拟）';
Blockly.MIXLY_COOLGUY_GRAYSCALE='灰度（模拟）';
Blockly.MIXLY_COOLGUY_FLAME='火焰（模拟）';
Blockly.MIXLY_COOLGUY_TEMPERATURE='温度（模拟）';
Blockly.MIXLY_TEMPERATURE='温度（℃）';
Blockly.MIXLY_COOLGUY_ACCELEROMETER='三轴加速度（模拟）';
Blockly.MIXLY_COOLGUY_MOISTURE='土壤湿度（模拟）';
Blockly.MIXLY_COOLGUY_WATER='水分（模拟）';
Blockly.MIXLY_COOLGUY_CO='一氧化碳（模拟）';
Blockly.MIXLY_COOLGUY_SHARP_GP2Y0A21='夏普GP2Y0A21红外测距（模拟）';
...
Blockly.MIXLY_COOLGUY_LCD='液晶显示屏';
...
// Blockly.MIXLY_COOLGUY_AIRQUALITY="读五灰度传感器";
