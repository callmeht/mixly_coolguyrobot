...
Blockly.MIXLY_COOLGUY_LED=' LED燈';
Blockly.MIXLY_COOLGUY_BUZZER='蜂鳴器';
Blockly.MIXLY_COOLGUY_BTN='按鈕（數位）';
Blockly.MIXLY_COOLGUY_VIBRATION='震動（數位）';
Blockly.MIXLY_COOLGUY_TILT='傾斜（數位）';
Blockly.MIXLY_COOLGUY_TOUCH='觸摸（數位）';
Blockly.MIXLY_COOLGUY_MAGNETIC='磁感應（數位）';
Blockly.MIXLY_COOLGUY_PYROELECTRIC_INFRARED='熱釋電紅外（數位）';
Blockly.MIXLY_MB_PYROELECTRIC_INFRARED='人體紅外';
Blockly.MIXLY_COOLGUY_JOYSTICK_D='搖杆-按鈕（數位）';
Blockly.MIXLY_COOLGUY_JOYSTICK_A='搖杆（類比）';
Blockly.MIXLY_JOYSTICK='搖杆';
Blockly.MIXLY_COOLGUY_POTENTIOMETER='電位器（類比）';
Blockly.MIXLY_POTENTIOMETER='電位器';
Blockly.MIXLY_COOLGUY_ROTATION='角度（類比）';
Blockly.MIXLY_COOLGUY_VOLTAGE='電壓（類比）';
Blockly.MIXLY_COOLGUY_PIEZO_DISK_VIRBRATION='壓電陶瓷震動（類比）';
Blockly.MIXLY_COOLGUY_SOUND='聲音（類比）';
Blockly.MIXLY_SOUND='聲音';
Blockly.MIXLY_COOLGUY_RELAY='繼電器';
Blockly.MIXLY_COOLGUY_LIGHT='光線（類比）';
Blockly.MIXLY_COOLGUY_GRAYSCALE='灰度（類比）';
Blockly.MIXLY_COOLGUY_FLAME='火焰（類比）';
Blockly.MIXLY_COOLGUY_TEMPERATURE='溫度（類比）';
Blockly.MIXLY_TEMPERATURE='溫度（℃）';
Blockly.MIXLY_COOLGUY_ACCELEROMETER='三軸加速度（類比）';
Blockly.MIXLY_COOLGUY_MOISTURE='土壤濕度（類比）';
Blockly.MIXLY_COOLGUY_WATER='水分（類比）';
Blockly.MIXLY_COOLGUY_CO='一氧化碳（類比）';
Blockly.MIXLY_COOLGUY_SHARP_GP2Y0A21='夏普GP2Y0A21紅外測距（類比）';
...
Blockly.MIXLY_COOLGUY_LCD='液晶顯示屏';
