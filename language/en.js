...
Blockly.MIXLY_COOLGUY_LED='LEDLED';
Blockly.MIXLY_COOLGUY_BUZZER='Buzzer';
Blockly.MIXLY_COOLGUY_BTN='Button';
Blockly.MIXLY_COOLGUY_VIBRATION='Vibration';
Blockly.MIXLY_COOLGUY_TILT='Tilt';
Blockly.MIXLY_COOLGUY_TOUCH='Touch';
Blockly.MIXLY_COOLGUY_MAGNETIC='Magnetic';
Blockly.MIXLY_COOLGUY_PYROELECTRIC_INFRARED='Pyroelectric infrared';
Blockly.MIXLY_MB_PYROELECTRIC_INFRARED='PIR Motion';
Blockly.MIXLY_COOLGUY_JOYSTICK_D='Joystick button';
Blockly.MIXLY_COOLGUY_JOYSTICK_A='Joystick';
Blockly.MIXLY_JOYSTICK='Joystick';
Blockly.MIXLY_COOLGUY_POTENTIOMETER='Potentiometer';
Blockly.MIXLY_POTENTIOMETER='Potentiometer';
Blockly.MIXLY_COOLGUY_ROTATION='Rotation';
Blockly.MIXLY_COOLGUY_VOLTAGE='Voltage';
Blockly.MIXLY_COOLGUY_PIEZO_DISK_VIRBRATION='Piezo disk virbration';
Blockly.MIXLY_COOLGUY_SOUND='Sound';
Blockly.MIXLY_SOUND='Sound';
Blockly.MIXLY_COOLGUY_RELAY='Relay';
Blockly.MIXLY_COOLGUY_LIGHT='Light';
Blockly.MIXLY_COOLGUY_GRAYSCALE='Grayscale';
Blockly.MIXLY_COOLGUY_FLAME='Flame';
Blockly.MIXLY_COOLGUY_TEMPERATURE='Temperature';
Blockly.MIXLY_TEMPERATURE='Temperature(℃)';
Blockly.MIXLY_COOLGUY_ACCELEROMETER='Accelerometer';
Blockly.MIXLY_COOLGUY_MOISTURE='Moisture';
Blockly.MIXLY_COOLGUY_WATER='Water';
Blockly.MIXLY_COOLGUY_CO='Carbon monoxide';
